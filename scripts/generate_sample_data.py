"""Generate small, deterministic geospatial fixtures for tests and demos."""
...
def generate_sample_data(data_dir: Path = DATA_DIR) -> tuple[Path, Path]:
...
if __name__ == "__main__":
    dem, zones = generate_sample_data()
    print(f"Created {dem}")
